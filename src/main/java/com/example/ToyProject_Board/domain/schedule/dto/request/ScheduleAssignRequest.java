...
@Getter
@NoArgsConstructor
@Schema(description = "연습실 수동 배정 요청")
public class ScheduleAssignRequest {
    ...
    @Schema(description = "대상 팀 ID", example = "1")
    @NotNull
    private Long teamId;

    @Schema(description = "연습 날짜", example = "2026-07-15")
    @NotNull
    ...
    @Schema(description = "배정할 연습실", example = "CLUB_ROOM")
    @NotNull
